...
public class Main {
	...
	public static void main(String[] args) {
		...
		for(int i = 0 ; i < 1000 ; i++) {
			...
			startTime = System.nanoTime();
			AlgoritmnAStar.BeamSearch(grafo, vertexes.get(source), vertexes.get(destiny), 15);
			endTime = System.nanoTime();
 ...
 */   
    ...
    */
    ...
    public static Graph<Integer, DefaultWeightedEdge> GenerateRandomGraph(List<Integer> vertexes )
	{
		...
		int maxVertexes = ThreadLocalRandom.current().nextInt(200,  300);
		...
		int addingEdges = ThreadLocalRandom.current().nextInt(250,  350);
